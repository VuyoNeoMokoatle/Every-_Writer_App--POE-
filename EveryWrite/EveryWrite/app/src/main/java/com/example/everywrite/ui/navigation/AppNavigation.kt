        ...
        AlertDialog(
            ...
            text = {
                Column {
                    ...
                    Text(
                        "Details: ${navigationError ?: "Unknown issue"}",
            ...
            SignupScreen(
                ...
                onBack = {
                    try {
                        ...
                        Log.d("Navigation", "📗 Going back from signup")
                    } catch (e: Exception) {
            ...
            NotesScreen(
                ...
                onLogout = {
                    try {
                        ...
                        Log.d("Navigation", "🌳 User logged out successfully")
                    } catch (e: Exception) {
        ...
        composable("reviews") {
            ReviewsScreen(
                onBack = {
                    try {
                        navController.popBackStack()
                        Log.d("Navigation", "📖 Going back from reviews")
                    } catch (e: Exception) {
        ...
        composable("noteDetail") {
            NoteDetailScreen(
                ...
                onBack = {
                    try {
                        navController.popBackStack()
                        Log.d("Navigation", "📝 Going back from note detail")
                    } catch (e: Exception) {
        ...
        composable("reminders") {
            RemindersScreen(
                onBack = {
                    try {
                        navController.popBackStack()
                        Log.d("Navigation", "⏰ Going back from reminders")
                    } catch (e: Exception) {
        ...
        composable("settings") {
            SettingsScreen(
                onBack = {
                    try {
                        navController.popBackStack()
                        Log.d("Navigation", "⚙️ Going back from settings")
                    } catch (e: Exception) {
                ...
                onClearCache = {
                    try {
                        ...
                        Log.d("Navigation", "🧹 Cache cleared successfully")
                    } catch (e: Exception) {
                        navigationError = "Failed to clear cache: ${e.message}"
                        showErrorDialog = true
                        Log.e("Navigation", "❌ Cache clearing failed", e)
                    }
                }
            )
        }
